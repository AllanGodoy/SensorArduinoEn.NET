...
namespace IT_Help_Desk.Web.Controllers
{
    ...
    public class UsersAdminController : Controller
    {
        ...
        //Controller to create new User Fer
        [HttpPost]
        public async Task<ActionResult> Create(RegisterViewModel userViewModel,
            params string[] selectedGroups)
        {
            
            //userViewModel.Email =userViewModel.Email+"@mail.com";
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser
                {
                    UserName = userViewModel._User,
                    Email = userViewModel._User + "@simtex-international.com"
                };
